...
let subPath = 'link';
let password = 'hello2026';
let proxyIP = 'ProxyIP.US.CMLiussss.net';
let yourUUID = '1ff6954f-e1c7-4fca-96f9-1d01985c938a';
 ...
 * {
 ...
 Powered by eooce Join Telegram group 
 ...
 * {
 ...
 Workers Service 
 基于 Cloudflare Workers 的高性能网络服务 (VLESS + Trojan) 
 ...
 Clash订阅地址 
 https://sublink.eooce.com/clash?config=${baseUrl}/${subPath} 
 
 
 singbox订阅地址 
 https://sublink.eooce.com/singbox?config=${baseUrl}/${subPath} 
